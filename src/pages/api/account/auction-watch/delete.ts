...
import { removeAuctionWatchForBuyer } from "../../../../lib/listings";
...
export const POST: APIRoute = async ({ request, locals }) => {
  ...
  await removeAuctionWatchForBuyer(db, owner.id, listingSlug);

  return new Response(null, {
    status: 303,
    headers: {
      Location: appendQueryFlag(redirectTo, "auctionWatchRemoved"),
    },
  });
};
