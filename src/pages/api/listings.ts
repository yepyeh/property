...
export const POST: APIRoute = async ({ request, locals }) => {
  ...
  try {
    ...
    const slug = await createListing(db, {
      ...
      saleMode: readEnum(form, "saleMode", ["private-sale", "auction"], "private-sale"),
      ...
      auctionStartsAt: readOptionalText(form, "auctionStartsAt", { maxLength: 40 }),
      auctionEndsAt: readOptionalText(form, "auctionEndsAt", { maxLength: 40 }),
      auctionStartingPriceLabel: readOptionalText(form, "auctionStartingPriceLabel", { maxLength: 120 }),
      auctionReservePriceLabel: readOptionalText(form, "auctionReservePriceLabel", { maxLength: 120 }),
      auctionTerms: readOptionalText(form, "auctionTerms", { maxLength: 1200 }),
